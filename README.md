...
## 개요
- C# 프로그래밍 학습
- 핵심기능: 패스워드 입력 내용을 숨기는 기능, Placeholder 기능, 탭을 이용한 입력 포커스 제어, 비밀번호 표시 기능, 텍스트 전체 삭제 기능
...
![과제3 실행화면](img/5wSc4.png)

![과제3 실행화면](img/5wSc5.png)

![과제3 실행화면](img/5wSc6.png)
...
- 과제 내용
	- 패스워드 표시 기능을 구현 했습니다. 패스워드 표시 기능은 버튼을 이용하여 구현했습니다.
	- 텍스트 전체 지우기 버튼을 구현 했습니다.
